...
Araba=Button(model="desoto.obj",color=color.white,texture="desoto_d.png",y=0,x=-15,parent=scene,scale=.05)
pil=Button(model="battery_alpha.obj",color=color.white,texture="battery_texture.png",x=30,y=1,parent=scene)
...
def filtre():
    ...
    if filt_kontrol1==False:
        ...
        agac=Button(model="tree.obj",texture="tree_text.png",color=color.white,x=20,z=30,parent=scene)
        invoke(txt.disable,delay=1)
    else:
