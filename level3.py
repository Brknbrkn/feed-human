...
fabrika=Button(model="Factory.obj",color=color.white,texture="Factory_albedo.jpg",parent=scene,x=20)
Araba=Button(model="desoto.obj",color=color.white,texture="desoto_d.png",y=0,x=-20,z=-5,parent=scene,scale=.05)
pil=Button(model="battery_alpha.obj",color=color.white,texture="battery_texture.png",x=30,y=1,z=30,parent=scene)
...
def filtre():
    ...
    if filt_kontrol1==False:
        ...
        agac=Button(model="tree.obj",texture="tree_text.png",color=color.white,x=25,z=30,parent=scene)
